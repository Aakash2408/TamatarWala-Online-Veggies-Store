...
var styles = { "keepAspectRatio": "styles_keepAspectRatio__1Vwpc", "round": "styles_round__20YBY" };
styleInject(css);
  ...
  function ReactImageWrapperComponent(props) {
    ...
    _this.changeImageSrc = function () {
      switch (_this.state.imageStatus) {
        case STATUS.SOURCE:
          _this.setState({ imageStatus: STATUS.FALLBACK });
          _this.img.src = _this.props.fallbackSrc;
          break;
        case STATUS.FALLBACK:
          _this.setState({ imageStatus: STATUS.AVATAR });
    ...
    _this.state = { imageStatus: STATUS.SOURCE };
    return _this;
  }
...
module.exports = ReactImageWrapperComponent;
